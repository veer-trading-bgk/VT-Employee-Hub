...
const knowledgeDocumentsRoutes = require('./routes/knowledgeDocuments');
...
app.use('/api/knowledge-documents', authMiddleware, subscriptionMiddleware, knowledgeDocumentsRoutes);
...
// Journey public capability-URL — no auth; token is the credential (Task 7/8)
