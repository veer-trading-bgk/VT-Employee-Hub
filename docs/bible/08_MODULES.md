...
| `settings/` | `WabaHealthPanel.tsx` (WABA health/status widget) + `WhatsAppFlowsPanel.tsx` (register/list/delete WhatsApp Flows by Meta Flow ID — mounted inside `WhatsAppSection` in `settings/page.tsx`, connected-only) |
