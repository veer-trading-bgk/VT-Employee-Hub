...
**Status:** implemented, tested, validated against real data, documented. Not yet committed — held for review, same standing rule as every other change this session.
