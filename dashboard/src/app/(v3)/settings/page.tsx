...
const SECTIONS: SectionDef[] = [
  ...
  // No 'instagram' entry (PR4, ADR-022): Instagram's connect/disconnect UI now
  // lives ONLY in the consolidated /instagram page's own Settings tab
...
// Instagram's connect/disconnect UI used to live here as a local
// InstagramSection component (v1, Era 54). PR4 (ADR-022) extracted it into
// the shared, standalone InstagramSettingsPanel component and removed it from
// this page entirely — Instagram is now configured ONLY from the consolidated
// /instagram page's own Settings tab, not duplicated in both places. See
// src/components/instagram/InstagramSettingsPanel.tsx and docs/adr/ADR-022.
