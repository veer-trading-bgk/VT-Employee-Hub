...
const ALL_NAV: NavItem[] = [
  ...
  { href: '/admin/crm',              label: 'CRM Pipeline',    icon: '🤝',  roles: ['admin'] },
  { href: '/admin/crm/analytics',   label: 'CRM Analytics',   icon: '📊',  roles: ['admin'] },
  { href: '/admin/crm/automations', label: 'Automations',     icon: '⚡',  roles: ['admin'] },
  { href: '/admin/crm/forms',       label: 'Lead Forms',      icon: '📋',  roles: ['admin'] },
  { href: '/admin/crm/settings',    label: 'CRM Settings',    icon: '⚙️',  roles: ['admin'] },
  { href: '/admin/whatsapp',        label: 'WA Inbox',        icon: '💬',  roles: ['admin'] },
  { href: '/admin/whatsapp/templates', label: 'WA Templates', icon: '📝',  roles: ['admin'] },
  { href: '/admin/whatsapp/broadcast', label: 'Broadcast',    icon: '📢',  roles: ['admin'] },
