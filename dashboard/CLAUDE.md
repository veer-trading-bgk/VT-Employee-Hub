...
- GitHub Actions (.github/workflows/deploy.yml) automatically deploys to Lambda on every push to main
- After pushing, tell the user: "Pushed. GitHub Actions will auto-deploy to Lambda — monitor at github.com/veer-trading-bgk/VT-Employee-Hub/actions"
